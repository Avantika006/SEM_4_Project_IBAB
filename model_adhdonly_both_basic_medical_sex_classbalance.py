...
##-- SEX BASED CLASS BALANCING - TRIED USING SEX IN FEATURES AND WITHOUT IT --##
...
#     fig1.savefig("waterfall_plot_sex_cb.png", bbox_inches='tight')
#
#     #2. Summary plot/ Feature Importance plot - Average SHAP values
#     fig2 = plt.figure()
#     class_names = ['ADHD', 'AuDHD']
#     shap.summary_plot(new_shap_values, X_test_original_exp, plot_type="bar", class_names= class_names, feature_names = features, show=False)
#     fig2.savefig("feat_imp_sex_cb.png", bbox_inches='tight')
#
...
#     fig3.savefig("beeswarm_sex_cb.png", bbox_inches='tight')
    ...
    # fig4.savefig("dependence_plot_sex_cb.png", bbox_inches='tight')

    #5. Force plot - for 1 prediction
    # shap.initjs()
    # fig5 = plt.figure()
    # shap.plots.force(exp.expected_value,exp.values[0,:],X_test_original.iloc[0,:])
    # fig5.savefig("force_plot_sex_cb.png", bbox_inches='tight')

    #6. Heatmap
    # fig6 = plt.figure()
    # shap.plots.heatmap(exp,show=False)
    # fig6.savefig("shap_heatmap_sex_cb.png", bbox_inches='tight')
...
print("The number of males in the dataset are:", male.shape[0])
print("The number of females in the dataset are:", female.shape[0])

# Randomly sample an equal number of rows from the adhd only individuals subset
male_sampled = male.sample(n=female.shape[0], random_state=42)

# Concatenate the ASD-affected subset and the randomly sampled unaffected individuals subset
merged_df_1 = pd.concat([female, male_sampled])
...
# # plt.show()
# fig1.savefig("conf_matrix_heatmap_sex_cb.png", bbox_inches='tight')
...
# plt.grid(True)
# # plt.show()
# fig2.savefig("metrics_fold_change_sex_cb.png", bbox_inches='tight')
#
#
...
# # plt.show()
# fig3.savefig("ROC_sex_cb.png", bbox_inches='tight')
#
#
...
# plt.legend(loc='lower right')
# # plt.show()
# fig4.savefig("Precision_Recall_sex_cb.png", bbox_inches='tight')
#
#
...
# # Display the heatmap
# # plt.show()
# fig5.savefig("Features_corr_heatmap_sex_cb.png", bbox_inches='tight')
